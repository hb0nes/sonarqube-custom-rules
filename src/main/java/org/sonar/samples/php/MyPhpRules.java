...
import org.sonar.samples.php.checks.LaravelAppDebugCheck;
...
public class MyPhpRules implements RulesDefinition, PHPCustomRuleRepository {
    ...
    public List<Class> checkClasses() {
        return List.of(LaravelRawQueryCheck.class, LaravelFileValidationCheck.class, LaravelAppDebugCheck.class);
    }
